			...
			<div class="col-md-4">
				<div class="panel panel-default">
					...
					<ul class="list-group">
						...
						<li class="list-group-item"><span class="glyphicon glyphicon-envelope"></span> @if(!is_null(Auth::user()->classroom->first()->name)){{Auth::user()->classroom->first()->name}}@endif</li>
					</ul>
				</div>
